...
upgrade:
	curl -OL https://www.microarch.org/micro${YEAR}/submit/micro${YEAR}-latex-template.zip
	unzip -o micro${YEAR}-latex-template.zip micro${YEAR}-latex-template/sig-alternate.cls
	cp micro${YEAR}-latex-template/* .
	$(RM) -r micro${YEAR}-latex-template*
